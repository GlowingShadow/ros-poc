"""postprocessA: receives frames on /pipeline/frame_to_a, sleeps for an
arbitrary duration (fake processing), stamps 'postprocessA' onto the frame,
and forwards it to /pipeline/frame_to_b. Fully self-contained: no shared code
with manager/postprocess_b/postprocess_c beyond the pipeline_interfaces
message definitions.
"""
import os
import random
...
ROLE = 'postprocessA'
IN_TOPIC = '/pipeline/frame_to_a'
OUT_TOPIC = '/pipeline/frame_to_b'
